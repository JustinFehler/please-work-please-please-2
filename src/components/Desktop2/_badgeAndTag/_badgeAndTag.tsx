...
import classes from './_badgeAndTag.module.css';
...
/* @figmaId 1814:69 */
export const _badgeAndTag: FC<Props> = memo(function _badgeAndTag(props = {}) {
  return (
    <div className={`${resets.storybrainResets} ${props.classes?.root || ''} ${props.className || ''} ${classes.root}`}>
      {!props.hide?.avatar &&
        (props.swap?.avatar || (
          <Avatar04
            ...
            classes={{ avatar04: `${props.classes?.avatar04 || ''} ${classes.avatar04}` }}
          />
        ))}
      {!props.hide?.stars && (
        <Stars
      ...
      <div className={classes.placeholder}>
        ...
        {props.text?.placeholder != null ? props.text?.placeholder : <div className={classes.placeholder2}>Badge</div>}
      </div>
